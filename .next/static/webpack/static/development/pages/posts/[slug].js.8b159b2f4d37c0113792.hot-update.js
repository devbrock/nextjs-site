...
function BlogTemplate(props) {
  ...
  var _props$content = props.content,
      ...
      author = _props$content.author,
      date = _props$content.date,
      data = _props$content.data;
  console.log(title);
  console.log(author);
  console.log(date);
  console.log(data);
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          console.log(content["default"].title);
...
//# sourceMappingURL=[slug].js.8b159b2f4d37c0113792.hot-update.js.map