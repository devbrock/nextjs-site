...
BlogTemplate.getInitialProps = async function (context) {
  ...
  const content = await __webpack_require__("./posts lazy recursive ^\\.\\/.*\\.md$")(`./${slug}.md`); // also grab the config file so we can pass down siteTitle
  // const config = await import(`../../data/config.json`)
  //gray-matter parses the yaml frontmatter from the md body

  const data = gray_matter__WEBPACK_IMPORTED_MODULE_8___default()(content.default);
