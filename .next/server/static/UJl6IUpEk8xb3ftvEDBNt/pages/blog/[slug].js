...
/******/ 			var chunk = require("../../../../" + ({}[chunkId]||chunkId) + "." + {"8":"b19d51c10192d662a0bc","9":"c86c3252e58cc97951db"}[chunkId] + ".js");
...
function BlogTemplate(props) {
  ...
  const title = "";
  const author = "";
  const date = ""; // const frontmatter = props.data
  ...
  }, __jsx("h1", null, title), __jsx("h4", null, author, " | ", reformatDate(date)), __jsx("div", null, __jsx(external_react_markdown_default.a, {
    source: markdownBody
  })))));
}
...
/* harmony default export */ var _slug_ = __webpack_exports__["default"] = (BlogTemplate);
